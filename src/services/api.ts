...
export const api = {
  ...
  classroom: {
    create: async (classroomName: string) => {
      const response = await fetch(
        `${API_URL}/mentor/createClassroom?classroomName=${encodeURIComponent(
          classroomName
        )}`,
        {
          method: "POST",
    ...
    getById: async (role: "mentor" | "learner", classroomId: string) => {
      const response = await fetch(
        `${API_URL}/${role}/classrooms/${classroomId}`
      );
      return response.json();
    },
    ...
    update: async (id: string, newName: string) => {
      const response = await fetch(
        `${API_URL}/mentor/updateClassroom/${id}?newName=${encodeURIComponent(
          newName
        )}`,
        {
          method: "PUT",
  ...
  files: {
    ...
    getAll: async (role: "mentor" | "learner", classroomId: string) => {
      const response = await fetch(
        `${API_URL}/${role}/classroom/files/all/${classroomId}`
      );
      return response.json();
    },
    download: async (role: "mentor" | "learner", fileId: string) => {
      const response = await fetch(
        `${API_URL}/${role}/classroom/files/download/${fileId}`
      );
      return response.blob();
    },
    delete: async (fileId: string) => {
      const response = await fetch(
        `${API_URL}/mentor/classroom/files/delete/${fileId}`,
        {
          method: "DELETE",
        }
      );
    ...
    deleteAll: async (classroomId: string) => {
      const response = await fetch(
        `${API_URL}/mentor/classroom/files/delete-all/${classroomId}`,
        {
          method: "DELETE",
        }
      );
    ...
    getMetadata: async (fileId: string) => {
      const response = await fetch(
        `${API_URL}/learner/files/metadata/${fileId}`
      );
      return response.json();
    },
    preview: async (fileId: string) => {
      const response = await fetch(
        `${API_URL}/learner/files/preview/${fileId}`
      );
      return response.json();
    },
  },
